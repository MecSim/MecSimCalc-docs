...
Start by creating an input group by clicking on the ![img alt](/docs/getting-started/add_btn.png) button and choosing **Input Group**. A new input group will be created with the title: "New Input Group Title". Click on the ![img alt](/docs/getting-started/edit_btn.png) icon (in the top right of the input group) to edit the title and change it to: "Converter".
